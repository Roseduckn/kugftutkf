<html>
  <head>
    ...
    <body>
        <header>
            <img class="logo" id ="logo" src="/uploads/2020/12/logo_0_1607675596.svg" height="40px"/>
            <b>Внимание! Сезонные скидки 40% </b><a class="a_head" href="#discount">Подробнее</a>
        </header>
        <main>
            <nav>
                <a class="nav_text" href="#price">Продукция</a>
                <a class="nav_text" href="#delivery">Как купить?</a>
                <a class="nav_text" href="#wholesale">Оптом</a>
                <a class="nav_text" href="#about_us">О компании</a>
            </nav>
        ...
        <footer>
            <p class="shrek_ultra" id="contacts"><b><i>Контакты</i></b></p>
            <p class="shrek">Адрес: г. Звёздный, пр-кт. Экспериментальный, 21</p>
            <p class="shrek">Тел.: 2502-3716</p>
        </footer>
    </body>
</html>
